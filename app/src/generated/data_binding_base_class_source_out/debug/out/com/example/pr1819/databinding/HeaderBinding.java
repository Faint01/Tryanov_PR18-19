...
public final class HeaderBinding implements ViewBinding {
  ...
  private HeaderBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView,
  ...
  public static HeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HeaderBinding((ConstraintLayout) rootView, imageView, textView);
    }
